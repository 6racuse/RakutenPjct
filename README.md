...
[lien models](https://we.tl/t-azlrUXntbz)
...
- **26/05** fermeture de la *version e1r3*, début du merge de la final solution sur le main, pre *version e2r0* , rédaction rapport.
- **27/05** Quasiment que des tests de régressions, tests fonctionnels, fermeture de la *version e2r0* et fin du rapport. 
### Welto CANDE
